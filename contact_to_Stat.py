...
def moveStatFile():
    ...
    for embryo_name in max_times.keys():
        shutil.copy(os.path.join(
            r'C:\Users\zelinli6\OneDrive - City University of Hong Kong - Student\MembraneProject\GUIData\WebData_CMap_cell_label_v0.1\\',
    ...
    for embryo_name in embryo_names:
        shutil.copy(os.path.join(
            r'C:\Users\zelinli6\OneDrive - City University of Hong Kong - Student\MembraneProject\GUIData\WebData_cshaper_v1.1\\',
            embryo_name, embryo_name + '_Stat.csv'),
                    os.path.join(r'C:\Users\zelinli6\OneDrive - City University of Hong Kong - Student\Desktop\tem',
                                 embryo_name + '_Stat.csv'))
...
def CShaperAddZeroToUnresonableBlank():
    current_folder = r'C:\Users\zelinli6\OneDrive - City University of Hong Kong - Student\MembraneProject\GUIData\WebData_cshaper_v1\\'
    data_folder = r'C:\Users\zelinli6\OneDrive - City University of Hong Kong - Student\MembraneProject\GUIData\WebData_cshaper_v1.1\\'
...
def CMapAddZeroToUnresonableBlank():
    current_folder=r'C:\Users\zelinli6\OneDrive - City University of Hong Kong - Student\MembraneProject\GUIData\WebData_CMap_cell_label_v0\\'
    data_folder=r'C:\Users\zelinli6\OneDrive - City University of Hong Kong - Student\MembraneProject\GUIData\WebData_CMap_cell_label_v0.1'
