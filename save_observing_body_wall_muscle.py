...
predecent_len=2
new_target_obj_cell_set_list=[set(),set(),set(),set(),set()]
...
obj_list=glob.glob(os.path.join(r'F:\obj_web_visulizaiton\obj_combined\200109plc1p1', '*.obj'))
dst_folder=r'F:\CMap_paper\Figures\Muscle Cells\201009_transparent_objs'
count_cell_list=[]
for obj_path in obj_list:
    print('dealing with ' + obj_path)
    obj_save_path=os.path.join(dst_folder,'muscle_'+os.path.basename(obj_path))
...
# =============resave obj ===================
source_dir=r'F:\CMap_paper\Figures\Muscle Cells\201009_transparent_objs'
objs_list=glob.glob(os.path.join(source_dir,'*.obj'))
dst_folder=r'F:\CMap_paper\Figures\Muscle Cells\201009_objs'
target_cells=set()
...
# for idx, targe_cell_name_list in enumerate(target_cells):
    ...
    obj_save_path=os.path.join(dst_folder,os.path.basename(obj_path))
