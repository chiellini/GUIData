...
obj_path=os.path.join(r'F:\CMap_paper\Figures\TissueMovieNoLoss\original_obj', '200326plc1p4_155_segCell_for_skin.obj')
...
for cell_name_this, cell_fate_this in cell_fate_dict.items():
    if cell_fate_this==cell_fate_target:
...
for idx, targe_cell_name_list in enumerate(target_cells):
    ...
    for line in obj_lines:
        ...
        if reading_selected_group:
            ...
            if line.startswith('f'):
                ...
                selected_cell_data.append('usemtl mat_'+cell_fate_target+'\n')
            else:
    ...
    obj_save_path=os.path.join(r'F:\CMap_paper\Figures\TissueMovieNoLoss\tissue_obj',os.path.basename(obj_path))
